...
def generate_barcodes(bin_arr, save_file_path_and_name):
    x = 1;
...
def test_page_injection():
    # test injecting into page
    im = Image.open("test-images/blank_form.jpg")
    ...
    im.save("test-images/output.png")